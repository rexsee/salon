...
<!--
<div class="form-group row">
    {{ Form::label('occupation', 'Occupation', ['class'=>'col-form-label col-sm-2']) }}
    <div class="col-sm-10">
        {{ Form::text('occupation', old('occupation'), ['class'=>'form-control', 'placeholder'=>'Optional']) }}
    </div>
</div>
-->
<div class="form-group row">
    {{ Form::label('category', 'Category', ['class'=>'col-form-label col-sm-2']) }}
    <div class="col-sm-10">
        {{ Form::select('category', getCustomerCategory(), null, ['class'=>'form-control']) }}
    </div>
</div>
